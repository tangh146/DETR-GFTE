...
from utils import get_table_grid, process_target, get_feature_vec,construct_basic_knn_graph
...
class TrainDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        edge_index = construct_basic_knn_graph(bboxes, k=5)
        ...
        #return data, gt_classes, bboxes,edge_index  Uncomment this for KNN(revised).ipynb
